...
class AccountSearch:
    def __init__(self, filters, keywords=None, start=0, count=100, spell_correction_enabled=False):
    ...
    def build_url(self):
        base_url = "https://www.linkedin.com/sales-api/salesApiAccountSearch?q=searchQuery&query=({{query}})&start={{start}}&count={{count}}"
        ...
        url = base_url.replace("{{query}}", query_string)
